...
---
Research Questions
Were the lifeboats sufficient to accommodate all passengers, regardless of class?
Was the "women and children first" protocol applied consistently across all passenger classes?
Was survival correlated with passenger class?
---
Key Findings
...
Open `code/titanic\\\_analysis.R` in RStudio
Load `data/titanic\\\_clean.csv` (update the file path if needed)
Run the script sequentially — all figures and the probability table will be generated
Required packages:
```r
